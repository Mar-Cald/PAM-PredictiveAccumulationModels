...
```{r, fig.height = 3, fig.width = 8, fig.align = 'left', dpi=300}
...
```{r, fig.height = 5, fig.width = 8,fig.align = 'left', dpi=300}
...
```{r, fig.height = 5, fig.width = 8, fig.align = 'left', dpi=300, warning=FALSE, message = FALSE}
mcmc_recover_hist(
    x = df_check[1:7],
